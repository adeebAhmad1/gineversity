  ...
  render() {
    return (
      <div className="col-lg-12">
        <div style={{ backgroundColor: "#fff", marginBottom: "3rem", boxShadow: "0 5px 5px #777", borderRadius: "5px", overflow: "hidden" }}>
          ...
          <form className="col-lg-12 col-md-12 col-12 login-card">
            ...
            <div style={{ textAlign: "center" }}>
              <Link to="/" className="btn col-4 btn-outline-danger pt-3 pb-3 mr-2 btnStyle">Submit for Preview</Link>
            </div>
          </form>
        </div>
