...
const navStyle = { display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', minHeight: '10vh',marginBottom: "3rem", marginLeft: 'auto', marginRight: 'auto' };
